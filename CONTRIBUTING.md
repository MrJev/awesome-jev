...
- **Numbers need a source.** Speed, cost, or accuracy figures must come from the project itself, and we mark them as author-reported.
- **Working code.** The repository should have a README explaining what it does and how to run it.
- Check that your link isn't already listed.

Projects that go unmaintained or stop working may be removed or marked accordingly.
